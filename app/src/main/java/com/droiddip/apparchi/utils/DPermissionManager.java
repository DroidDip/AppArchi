...
import com.music.arts.ui.dialog.PermissionDialogFragment;
 ...
 * app.
 */
public class DPermissionManager {

    private static final String TAG = "DPermissionManager";
     ...
     * {@link DPermissionManager#setActivity(Activity)} or else bad things will happen.
     */
     ...
     */
    private static DPermissionManager sInstance = new DPermissionManager();
    ...
    /**
     * @return An instance of {@link DPermissionManager} to help you manage your permissions.
     */
    public static DPermissionManager getInstance() {
        return sInstance;
    }
     ...
     * permissions. Even if you don't want to use DPermissionManager in your current activity, you should call this method
     * with a null activity to prevent leaking the previously-set activity.
     * <p>
     * <strong>Important: </strong> If your activity subclasses , this is already handled for you.
    ...
    /**
     * Request one or more permissions from the system. Make sure that you are either subclassing
     * or that you have set your current activity using {@link DPermissionManager#setActivity(Activity)}!
     * @param callback
    ...
    public void showRationaleInDialog(@Nullable String title, @NonNull String message, @Nullable String buttonText, @NonNull final IOnRationaleProvided rationaleCallback) {
        ...
        dialogFragment.show(mActivity.get().getFragmentManager(), PermissionDialogFragment.TAG);
    }
    ...
    private void checkActivity() {
        if (mActivity.get() == null) {
            throw new IllegalStateException("No activity set. Either subclass PermisoActivity or call DPermissionManager.setActivity() in onCreate() and onResume() of your Activity.");
        }
    }
    ...
    /**
     * Simple callback to let DPermissionManager know that you have finished providing the user a rationale for a set of permissions.
     * For easy handling of this callback, consider using
     * {@link DPermissionManager#showRationaleInDialog(String, String, String, IOnRationaleProvided)}.
     */
