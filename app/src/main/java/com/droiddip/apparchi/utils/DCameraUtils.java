...
/**
 * Created by Dipanjan Chakraborty on 17-05-2017.
 */

public class DCameraUtils {

    private DCameraUtils() {
     ...
     * @return
     */
    public static String getImagePathFromData(Intent data, Context context) {
    ...
    /**
     * Method used to decode Bitmap File
     *
     * @param imageFile
     * @param reqWidth
     * @param reqHeight
